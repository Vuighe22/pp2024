...
def decompress_files():
    if os.path.exists(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw5\pw5\students.dat.zip'):
        directory = r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw5\pw5\students_dat'
        if not os.path.exists(directory):
            os.makedirs(directory)
        with zipfile.ZipFile(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw5\pw5\students.dat.zip', 'r') as zip_object:
