...
def Show_Inf_Cs():
    ...
    with open(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students_dat\courses.txt','rb') as cs_file:
...
def Show_Mark():
    ...
    with open(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students_dat\courses.txt','rb') as cs_file:
        ...
        print('\t'.join(header))
        with open(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students_dat\students.txt','rb') as st_file:
            ...
            for St in List_St:
                ...
                with open(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students_dat\marks.txt','rb') as mk_file:
...
def decompress_files():
    if os.path.exists(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students.dat.zip'):
        directory = r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students_dat'
        if not os.path.exists(directory):
            os.makedirs(directory)
        with zipfile.ZipFile(r'C:\Users\PC\Documents\Python_for_Son\pp2024\pw9\students.dat.zip', 'r') as zip_object:
